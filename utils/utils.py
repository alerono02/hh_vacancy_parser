...
from source.hh import HeadHunterAPI
from source.DBManager import DBManage
...
def welcome():
    ...
    input("Нажмите 'ENTER' клавишу для продолжения")
...
def interact_with_user():
    ...
    try:
        ...
        while True:
            ...
            print("2 - Пересоздание базы данных и таблиц ")
            print("3 - Заполняем таблицы БД данными")
            print("4 - Вывод всех вакансий")
            print("5 - Вывод средней зарплаты")
            ...
            print("8 - Список всех компаний и количество вакансий у каждой компании")
            print("9 - Выйти")
            ...
            if choice == "1":
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(
                                "Данные уже занесены, повторно не требуется"
                                "Если хотите изменить - удалите и заново создайте таблицу и БД")
                        else:
                ...
                try:
                    ...
                    # Отрабатываем случай если в таблице нет данных
                    if vacancies_with_higher_salary is []:
                        print("Нет таблиц, создайте - пункт 2")
                    else:
                ...
                try:
                    ...
                    # Отрабатываем случай если в таблице нет данных
                    if vacancies_with_keyword is []:
                        print("Нет таблиц, создайте - пункт 2 или нет соответствий")
                    else:
                ...
                try:
                    ...
                    # Отрабатываем случай если в таблице нет данных
                    if companies_and_vacancies_count is []:
                        print("Нет таблиц, создайте - пункт 2")
                    else:
